...
wil_import = np.genfromtxt(r"%s\data\Cij-NonLin-eNLA_15gen\WiGamma-LCDM-NonLin-eNLA.dat" %(path))
def wil_tot(z,i):
...
wig_import = np.genfromtxt(r"%s\data\Cij-NonLin-eNLA_15gen\WiG-LCDM-NonLin-eNLA.dat" %(path))
def wig(z,i):
    # it's i+1: first column is for the redshift array
