...
Cij_output_folder = "Cijs_v15_newBias_WFvincenzo"
...
# here wig -> wig_nobias
wig_import = np.genfromtxt("%s/data/everyones_WFs/%s/wig_vincenzo_8K_noBias_noSSC.txt" %(path_SSC, WF_input_folder))
def wig_noBias(z,i):
    # it's i+1: first column is for the redshift array
