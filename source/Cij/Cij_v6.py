...
def save():
    np.save(r"%s\output\Cijs_v4\Cij_LL.npy" %path, C_LL_array)
    np.save(r"%s\output\Cijs_v4\Cij_LG.npy" %path, C_LG_array)
    np.save(r"%s\output\Cijs_v4\Cij_GG.npy" %path, C_GG_array)
