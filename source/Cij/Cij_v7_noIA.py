...
def save():
    np.save(r"%s\output\Cijs_v4_noIA\Cij_LL.npy" %path, C_LL_array)
    np.save(r"%s\output\Cijs_v4_noIA\Cij_LG.npy" %path, C_LG_array)
    np.save(r"%s\output\Cijs_v4_noIA\Cij_GG.npy" %path, C_GG_array)
