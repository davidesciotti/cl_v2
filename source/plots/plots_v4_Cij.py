...
# davide ##########################################
Cij_folder = "Cijs_v10_WFvincenzo"
...
Cij_folder = "Cijs_v4_noIA"
Cij_folder = "Cijs_v5_noIA_zmax2.5"
Cij_folder = "Cijs_v9_IA_zmax4"
C_LL_vincenzo = np.load(r"%s\output\%s\Cij_LL.npy" %(path, Cij_folder))
C_LG_vincenzo = np.load(r"%s\output\%s\Cij_LG.npy" %(path, Cij_folder))
C_GG_vincenzo = np.load(r"%s\output\%s\Cij_GG.npy" %(path, Cij_folder))
# vincenzo ##############################
...
plt.plot(ell_values, C_LL_davide[:,i,j], label = "")
