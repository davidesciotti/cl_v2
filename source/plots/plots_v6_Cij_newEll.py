...
# Cij_folder = "Cij_WFdavide_IA_oldBias_nz300_optimised"
# CLL_WFdavide_IA_oldBias_nz300_NONoptimised = np.load("%s/output/Cij/Cijs_v19_ALL/%s/Cij_LL.npy" %(path, Cij_folder))

# davide v19 optimised
Cij_folder = "Cij_WFdavide_IA_newBias_nz10000"
Cij_WFdavide_IA_newBias_nz10000 = np.load("%s/output/Cij/Cijs_v19_ALL/%s/Cij_LL.npy" %(path, Cij_folder))
...
C_LL_vincenzo = np.genfromtxt(f"{path_new}/output/matrici_base/common_ell_and_deltas/Cij_14may/C_LL_nbl30_lmaxWL5000_WLonly.dat")
# C_LG_vincenzo = np.genfromtxt(f"{path_new}/output/matrici_base/common_ell_and_deltas/Cij_14may/CijGL-GR-Flat-eNLA-NA.dat")
C_GG_vincenzo = np.genfromtxt(f"{path_new}/output/matrici_base/common_ell_and_deltas/Cij_14may/C_GG_nbl30_lmaxGC3000_GConly.dat")
...
array_1 = Cij_WFdavide_IA_newBias_nz10000
...
plt.plot(ell_values, array_1[:,i,j], ".-", label = namestr(array_1, globals()))
plt.plot(ell_values, array_2[:,i,j], ".-", label = namestr(array_2, globals()))
