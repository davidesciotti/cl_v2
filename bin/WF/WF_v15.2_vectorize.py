...
# test this
L_ratio_new = interp1d(lumin_ratio[:, 0], lumin_ratio[:, 1], kind='linear')


z_test = np.linspace(0.001, 4, 10_000)

L_ratio_old_arr = L_ratio(z_test)
L_ratio_new_arr = L_ratio_new(z_test)

plt.plot(z_test, L_ratio_old_arr, label="old")
plt.plot(z_test, L_ratio_new_arr, label="new")
plt.legend()
plt.show()
